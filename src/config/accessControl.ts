...
export interface AccessConfigItem {
  ...
  passwordHash: string;
  /**
   * Secret TOTP en Base32 (solo para cuentas con 2FA habilitado).
   * Puedes generar uno con herramientas como otpauth.
   */
  totpSecret?: string;
}
...
export const ACCESS_CONFIG: AccessConfigItem[] = [
  ...
  { key: 'GENERAL', scope: 'general', region: null, passwordHash: '3e23052ed2ccbcb0e53adf909d1ddaa1068da9c92f46d35d785fd4805bd9bb01', totpSecret: 'JBSWY3DPEHPK3PXP' },
